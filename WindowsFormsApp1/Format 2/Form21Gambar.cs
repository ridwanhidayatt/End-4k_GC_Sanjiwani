...
namespace WindowsFormsApp1.Format_2
{
    public partial class Form21Gambar : Form
    {
        ...
        private void AdjustControlsLayout(int screenWidth, int screenHeight)
        {
            ...
            richTextBoxNRS.Location = new Point((int)(20 * scaleX), (int)(9 * scaleY));
            richTextBoxNRS.Size = new Size((int)(20 * scaleX), (int)(20 * scaleY));
        ...
        private void richTextBoxBE_TextChanged(object sender, EventArgs e)
        {
